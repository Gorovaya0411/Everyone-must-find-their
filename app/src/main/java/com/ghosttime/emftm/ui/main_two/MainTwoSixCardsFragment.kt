...
import com.ghosttime.emftm.databinding.FragmentMainTwoSixCardsBinding
import com.ghosttime.emftm.ui.main.MainActivity


class MainTwoSixCardsFragment : Fragment() {

    private lateinit var viewBinding: FragmentMainTwoSixCardsBinding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_main_two_six_cards, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        viewBinding = FragmentMainTwoSixCardsBinding.bind(view)
        ...
        with(viewBinding) {
            ...
            mainTwoSixCardsBackImgBtn.setOnClickListener {
            ...
            mainTwoSixCardsPauseImgBtn.setOnClickListener {
                if (contextActivity.presenter.getCheckSound()) {
                    contextActivity.startSound()
                }

                isNeedSave = true
                    findNavController().navigate(R.id.action_mainTwoSixCardsFragment_to_pauseFragment)
            }
            ...
            if (contextActivity.presenter.getOpenListCard().cards.isEmpty()) {
                ...
                contextActivity.presenter.getOpenListCard().cards.forEach { card ->
                    ...
                    if (card.isOpened) {
                        when (card.place) {
                            0 -> mainTwoSixCardsCard1.setBackgroundResource(card.image)
                            1 -> mainTwoSixCardsCard2.setBackgroundResource(card.image)
                            2 -> mainTwoSixCardsCard3.setBackgroundResource(card.image)
                            3 -> mainTwoSixCardsCard4.setBackgroundResource(card.image)
                            4 -> mainTwoSixCardsCard5.setBackgroundResource(card.image)
                            5 -> mainTwoSixCardsCard6.setBackgroundResource(card.image)
                            else -> {
                            }
                        }
                    }
            ...
            mainTwoSixCardsCard1.setOnClickListener {
                if (isClickable) {
                    mainAction(mainTwoSixCardsCard1, randomListCard[0])
                }
                openListCardNow = mainTwoSixCardsCard1
            }

            mainTwoSixCardsCard2.setOnClickListener {
                if (isClickable) {
                    mainAction(mainTwoSixCardsCard2, randomListCard[1])
                }
                openListCardNow = mainTwoSixCardsCard2
            }

            mainTwoSixCardsCard3.setOnClickListener {
                if (isClickable) {
                    mainAction(mainTwoSixCardsCard3, randomListCard[2])
                }
                openListCardNow = mainTwoSixCardsCard3
            }

            mainTwoSixCardsCard4.setOnClickListener {
                if (isClickable) {
                    mainAction(mainTwoSixCardsCard4, randomListCard[3])
                }
                openListCardNow = mainTwoSixCardsCard4
            }

            mainTwoSixCardsCard5.setOnClickListener {
                if (isClickable) {
                    mainAction(mainTwoSixCardsCard5, randomListCard[4])
                }
                openListCardNow = mainTwoSixCardsCard5
            }
            mainTwoSixCardsCard6.setOnClickListener {
                if (isClickable) {
                    mainAction(mainTwoSixCardsCard6, randomListCard[5])
                }
                openListCardNow = mainTwoSixCardsCard6
            }
    ...
    companion object{
        const val MAXIMUM_PAIRS_OF_PICTURES = 3
